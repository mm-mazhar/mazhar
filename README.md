...
* [Use Python To Send Emails](https://github.com/mazqoty/usePythonForSendingEmails/blob/main/sendEmails.py) Uses python to send email to multiple contacts with attachments including pics and other file types.
